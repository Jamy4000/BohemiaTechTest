...
{
    /// <summary>
    /// A simple extension for the Unity Pool system.
    /// This allows us to get some event callback for when objects are being pooled or returned to the pool,
    /// as well as being able to add preplaced objects in the scene into the pool.
    /// </summary>
    /// <typeparam name="TPoolable">The Poolable object, that should extends the IGenericPoolable interface</typeparam>
